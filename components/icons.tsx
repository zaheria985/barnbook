...
export function IconChartLine({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 3v18h18"/>
...
export function IconHorse({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className}>
      <path d="M22 6c0-1-0.5-2-1-2.5L19 2l-1 3c-3 0-5.5 1-7 3l-1 1.5c-0.5 0.7-1.5 1-2.5 0.8L6 10l-0.5 2c-0.3 1 0 2 0.8 2.7L8 16l-1 3c-0.3 0.8 0 1.7 0.7 2.1 0.8 0.5 1.8 0.2 2.3-0.6l2-3.5 3 0.5c2.5 0.4 5-0.7 6.2-2.8L22 13V6z"/>
    </svg>
  );
}
...
export function IconCloudSun({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 2v2"/>
